  ...
  return (
    <nav className="py-4">
      <div className="flex justify-between border-b-[#EFF0F3] border-b">
        <Link href="/">
          <img className="w-[157px]" src="./images/logo.png" alt="Jcns Solar power Logo " />
        </Link>
        <ul className="split:flex gap-x-6 max-split:h-screen max-split:w-screen max-split:bg-white max-split:absolute max-split:top-0 max-split:left-0 ">
          <li className="py-2 flex justify-end split:hidden">close</li>
        ...
        <span className="min-split:hidden flex items-center">
          <svg className="w-4 sm:w-8" viewBox="0 0 20 21" fill="none">
            <path
