...
import ProductsDropDown from "./products/products-dropdown-menu";
  ...
  return (
    <nav className="py-4 overflow-hidden">
      <div className="flex justify-between border-b-[#EFF0F3] border-b contentMargin max-split:max-w-full max-split:w-full">
        ...
        <ul
          className={
            "relative split:flex gap-x-6 max-split:h-screen max-split:z-20 max-split:w-full max-split:bg-white max-split:fixed max-split:top-0 transition-transform duration-200 " +
        ...
        >
          ...
          <ProductsDropDown active={pathname == "/products" || pathname.includes("/products/")}>Our Product</ProductsDropDown>
        ...
        <span className="min-split:hidden flex items-center cursor-pointer" onClick={() => setOpen(true)}>
