...
import bannerDesktop from "./components/images/banner.png";
import bannerMobile from "./components/images/banner-small.png";
  ...
  return (
    <>
      <section className="contentMargin">
        ...
        <div id="banner" className="relative mt-10">
          <div className="relative aspect-[2.187] max-split:aspect-[366/510] w-full rounded-[20px] overflow-hidden">
            <Image src={bannerDesktop} alt="Banner" fill sizes="(max-width: 768px) 100vw, 1312px" className="object-cover" priority />
            <Image src={bannerMobile} alt="Mobile Banner" fill sizes="100vw" className="object-cover max-md:block hidden" priority />
          </div>
          <div className="split:absolute -bottom-0 left-0">
            <motion.div
              ...
              variants={StaggerParent(0.5, 0.5)}
              id="caption"
              className="split:ps-5 relative max-w-[550px]"
            >
              <motion.h1 className="text-2xl font-bold mb-3" variants={AnimateToRight}>
                Our Solar products
              </motion.h1>
              <motion.div variants={AnimateToRight}>
      ...
      >
        ...
        <GreenCard variants={cardVariants} className="bg-primary py-8 px-6 rounded-2xl" label="Smart Energy (Energy Storage Solutions)">
          <svg className="w-[25px] split:w-10" viewBox="0 0 40 40" fill="none">
            <path
        ...
        <GreenCard variants={cardVariants} className="bg-primary py-8 px-6 rounded-2xl" label="Shenzhen Xingzhijie (LED lighting)">
          <svg className="w-[25px] split:w-10" viewBox="0 0 40 40" fill="none">
            <path
        ...
        <GreenCard variants={cardVariants} className="bg-primary py-8 px-6 rounded-2xl" label="Jiangxi Factory">
          <svg className="w-[25px] split:w-10" viewBox="0 0 40 40" fill="none">
            <path
      ...
      <section className="contentMargin bg-primary py-[120px] space-y-10">
        <SubHeading className="text-white" id="hiw">
          How It Works
        </SubHeading>
        <motion.div
          variants={StaggerParent()}
          ...
          className="gap-x-6 max-split:space-y-6 split:flex"
        >
          <motion.div variants={cardVariants} className="bg-white rounded-2xl py-12 px-8 space-y-4">
      ...
      <section className="contentMargin py-16 space-y-10">
        <SubHeading {...fadeInViewport}>What our customers say about us</SubHeading>
          ...
          <CustomerReview image="./images/david.png" variants={AnimateToRight}>
            <div className="grow-1 space-y-4 text-white">
              <div className="text-sm">
                ...
                <p className="text-xs text-white/60">Business man</p>
              </div>
          ...
          <CustomerReview image="./images/amaka.png" variants={AnimateToLeft}>
            <div className="grow-1 space-y-4">
              <div className="text-sm text-white">
                ...
                <p className="text-xs text-white/60">Home Owner</p>
              </div>
